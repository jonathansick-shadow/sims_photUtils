...
# Check on resampling - want all galaxy seds to have the same wavelength
# range (not necessarily same as the bandpass).
...
for i in range(num_gal):
    ...
    # version increases to a 2.5 times difference.  (i.e. this
    # 'synchronizeSED' buys you 1.6x faster, by itself.)
